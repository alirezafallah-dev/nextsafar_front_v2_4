  ...
  return (
    <div className={embedded ? "overflow-hidden" : "ns-card overflow-hidden"}>
      ...
      <div className="p-6 md:p-8">
        ...
        {step === 1 && (
          <div>
            <h3 className="font-extrabold text-lg mb-1">📍 کجا می‌خوای بری؟</h3>
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="flex items-center gap-4">
                ...
                />
                <span className="text-2xl font-extrabold text-primary min-w-20 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              {BUDGET_OPTIONS.map((opt) => (
                ...
                >
                  ...
                  <div className="font-extrabold mb-1">{opt.label}</div>
        ...
        {step === 5 && (
          <div>
            <h3 className="font-extrabold text-lg mb-1">✅ همه‌چیز درسته؟</h3>
            <p className="text-sm text-text-muted mb-5">
