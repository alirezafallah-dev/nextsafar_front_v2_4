    ...
    <div ref={wrapRef} className="relative">
      <div className="relative">
        ...
        <input
          ...
          className="w-full ps-9 pe-3 py-3 rounded-xl border border-border bg-white text-sm focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition"
        />
      </div>

      {open && filtered.length > 0 && (
        <div className="absolute z-30 mt-2 w-full max-h-64 overflow-y-auto rounded-xl border border-border bg-white shadow-card-hover">
