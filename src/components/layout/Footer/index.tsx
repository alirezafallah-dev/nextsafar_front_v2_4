...
export default function Footer() {
  return (
    <footer className="mt-20 border-t border-border">
      ...
      {/* ═══ بخش ۳: فوتر اصلی ═══ */}
      <div className="border-t bg-bg-sec border-border mt-10 pt-10 pb-8">
        <div className="max-w-[1280px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-[minmax(270px,1fr)_minmax(450px,3.2fr)_minmax(180px,0.9fr)] gap-8">
            ...
            <div>
              ...
              <p className="text-text-muted text-sm leading-relaxed">
                رزرو پرواز، هتل و تور با پشتیبانی ۲۴ ساعته؛ تجربه‌ای ساده، شفاف
                و مطمئن.
              </p>
              ...
              <ul className="mt-4 divide-y divide-border">
                <li className="grid grid-cols-[18px_1fr] gap-3 items-start py-3">
                  ...
                  <div className="flex items-start justify-between gap-4 flex-wrap">
                    <span className="font-extrabold text-text-strong text-sm">
                      آدرس
                    </span>
