/* ═══ نمادهای اعتماد — ✅ Radius توکن‌دار + badge‌های بزرگ‌تر ═══ */
const badges = [
  {
...
export default function TrustBox() {
  return (
    <div>
      ...
      <div className="border border-border rounded-lg p-3 bg-white shadow-card inline-block">
          ...
          {badges.map((badge) => (
            <li key={badge.name} className="flex items-center justify-center">
              <a
                ...
                title={badge.name}
                className="block w-full max-w-[90px] h-[80px]"
              >
                ...
                <img
                  ...
                  className="w-full h-full object-contain bg-white border border-border rounded-lg p-1.5 transition hover:opacity-85"
                />
              </a>
            </li>
          ))}
