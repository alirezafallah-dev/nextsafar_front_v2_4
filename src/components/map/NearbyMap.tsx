...
export default function NearbyMap({ center, places, height = 260 }: NearbyMapProps) {
  ...
  return (
    <div>
      <div className="relative rounded-xl overflow-hidden border border-border bg-bg-sec" style={{ height }}>
            ...
            <aside className="w-full md:w-80 border-t md:border-t-0 md:border-s border-divider overflow-y-auto p-3 space-y-2 bg-white">
              ...
              {places.map((p) => (
                <button
                  ...
                  className={`w-full text-start flex gap-2.5 p-2 rounded-xl border transition cursor-pointer ${
                    activeId === p.id
