  ...
  return (
    ...
    >
      ...
      <div className="absolute top-4 start-4 z-10">
        <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-md bg-gradient-to-r from-primary to-primary-dark text-white text-[11px]  shadow-lg">
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-3 start-3 z-10">
        <div className="flex items-center gap-1 px-2 py-1 rounded-md bg-gradient-to-r from-primary to-primary-dark text-white text-[10px]  shadow">
