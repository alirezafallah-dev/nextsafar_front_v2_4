  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[4/3] bg-gradient-to-br from-tour/20 to-primary-lightest/30 overflow-hidden">
        ...
        {item.duration && (
          <span className="absolute top-2.5 start-2.5 px-2.5 py-1 rounded-md bg-white/95 backdrop-blur text-[11px] font-extrabold text-tour-hover shadow">
        ...
        <div className="absolute bottom-2.5 inset-x-2.5">
          <div className="text-white font-extrabold text-base md:text-lg drop-shadow line-clamp-1">
            {item.name}
          </div>
        </div>
      </div>
