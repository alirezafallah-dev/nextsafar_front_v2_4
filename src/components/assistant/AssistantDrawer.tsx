      ...
      <aside className="relative w-full max-w-[420px] h-full bg-white shadow-2xl flex flex-col">
        ...
        <div className="flex items-center justify-between px-3 py-2.5 border-b border-divider">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <h2 className="text-sm font-extrabold">دستیار سفر</h2>
            <button
              type="button"
              ...
              <div className="flex-1 overflow-y-auto px-1.5 py-1">
                {sessions.length === 0 ? (
                  <div className="text-center pt-10 px-4">
                    <div className="w-10 h-10 mx-auto rounded-xl bg-bg-sec flex items-center justify-center mb-3">
        ...
        <div ref={listRef} className="flex-1 overflow-y-auto p-4 space-y-4">
          {messages.length === 0 && (
            <div className="text-center pt-8">
              ...
              <h3 className="text-sm font-extrabold mb-2">سلام! من دستیار سفرتم 👋</h3>
